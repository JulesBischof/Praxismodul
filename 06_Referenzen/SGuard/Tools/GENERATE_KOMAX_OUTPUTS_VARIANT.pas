Const
     ...
     FolderAssembly='AssemblyDataVariant';
     FolderPCB='PCBData';
...
Begin
    ...
    RunApplication('"' + ProjPath + 'Tools\7ZIP_ASSEMBLY_VARIANT.bat" "' + GetWorkspace.DM_FocusedProject.DM_GetOutputPath + '" "' + FolderAssembly + '" "' + FolderPCB + '"');
    ...
    Sleep(5000);
    ShowMessage('Variant files generated in the folder ' + FolderGeneratedFiles);
